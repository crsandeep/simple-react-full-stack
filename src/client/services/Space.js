...
export const updateSpace = async (space,fileMap) => {
...
export const removeSpaceImg = async (spaceId) => {
    return await ApiUtil.invokeApi(
...
export const addSpace = async (space,fileMap) => {
    return await ApiUtil.invokeApi(
...
export const getSpaceList = async (userId) => {
    return await ApiUtil.invokeApi(
